...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 ">
            ...
            <form class="form-horizontal" method="POST" action="{{url('pages/'.$data->id)}}">
                @if (count($errors) > 0)
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->name}}" class="form-control" id="name" name="name" placeholder="name" autocomplete="on" required >
                        @if ($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->type}}" class="form-control" id="type" name="type" placeholder="type" autocomplete="on" required>
                        @if ($errors->has('type'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->url}}" class="form-control" id="url" name="url" placeholder="正式环境URL" autocomplete="on" required >
                        @if ($errors->has('url'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('grey_url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->grey_url}}" class="form-control" id="grey_url" name="grey_url" placeholder="灰度环境URL" autocomplete="on" required >
                ...
                <div class="form-group{{ $errors->has('module_url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->module_url}}" class="form-control" id="module_url" name="module_url" placeholder="模块环境URL" autocomplete="on" required >
                ...
                <div class="form-group{{ $errors->has('creator') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->creator}}" class="form-control" id="creator" name="creator" autocomplete="on" placeholder="模块环境URL" >
                ...
                <div class="form-group{{ $errors->has('shuticon') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->shuticon}}" class="form-control" id="screenshot" name="shuticon" autocomplete="on" placeholder="模块环境URL" required>
                ...
                <div class="form-group{{ $errors->has('label') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->label}}" class="form-control" id="label" name="label" autocomplete="on" placeholder="技术标签">
                        @if ($errors->has('label'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('version') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->version}}" class="form-control"  name="version" autocomplete="on" placeholder="版本信息">
                ...
                <div class="form-group{{ $errors->has('ideas') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <textarea  class="form-control" name="ideas"  cols="15" rows="5" autocomplete="on">{{$data->ideas}}</textarea>
                        @if ($errors->has('ideas'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('mark') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <textarea  class="form-control" name="mark"  cols="15" rows="5" autocomplete="on">{{$data->mark}}</textarea>
                        @if ($errors->has('mark'))
                            <span class="help-block">
