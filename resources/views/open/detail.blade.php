...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 ">
            ...
            <form class="form-horizontal" method="POST" action="{{url('open/'.$data->id)}}">
                @if (count($errors) > 0)
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->name}}" class="form-control" id="name" name="name" placeholder="开源作品名称" autocomplete="on" required >
                        @if ($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->desc}}" class="form-control" id="desc" name="desc" placeholder="简单的描述" autocomplete="on" required>
                        @if ($errors->has('desc'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('label') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->label}}" class="form-control" id="label" name="label" placeholder="标签" autocomplete="on" required >
                        @if ($errors->has('label'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->author}}" class="form-control" id="author" name="author" placeholder="创建者" autocomplete="on" required >
                ...
                <div class="form-group{{ $errors->has('thumb') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->thumb}}" class="form-control" id="thumb" name="thumb" autocomplete="on" placeholder="thumb" required>
                        @if ($errors->has('thumb'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$data->url}}" class="form-control" id="url" name="url" autocomplete="on" placeholder="访问地址">
                        @if ($errors->has('url'))
                            <span class="help-block">
